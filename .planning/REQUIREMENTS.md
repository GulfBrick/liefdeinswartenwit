# Requirements: Liefde in Swart en Wit
...
- [ ] **ANI-01**: All existing IntersectionObserver reveal animations audited and working correctly
- [ ] **ANI-02**: New scroll-triggered animations added where appropriate

### Gallery

- [ ] **GAL-01**: New photos from Wedding Photos.zip extracted and added to gallery
- [ ] **GAL-02**: Colour reveal effect on mouse hover (grayscale-to-colour transition)
- [ ] **GAL-03**: Smart spacing in masonry grid with balanced visual layout

### Admin

- [ ] **ADM-01**: RSVP admin dashboard page showing all guest responses
- [ ] **ADM-02**: Admin access protected with code 1234, restricted to Nikita and Daniel only
...
| GAL-02 | Phase 5 | Pending |
| GAL-03 | Phase 5 | Pending |
